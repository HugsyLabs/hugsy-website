        ...
        <nav className="fixed top-0 w-full z-50 glass border-b border-gray-200/20 dark:border-gray-800/20">
          <div className="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-8">
              ...
              <Link href="https://discord.com/channels/1413008972406984724/1413009020410662932" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition">
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link href="https://discord.com/channels/1413008972406984724/1413009020410662932">Discord</Link>
